...
官网通过 `data/versions.json` 展示最近 3 个稳定版本的独立下载链接、发布时间、SHA256 与更新说明。0.3.8 正式包通过本公开仓库 Releases 无需登录下载，自动更新与手动下载均指向公开发行仓库；旧版仍按记录标明私有。后续版本必须先公开镜像并通过匿名哈希验证，再刷新官网。
